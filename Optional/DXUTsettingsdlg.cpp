...
WCHAR* DXUTD3DX10DeviceTypeToString( D3D10_DRIVER_TYPE devType )
{
    switch( devType )
    {
        case D3D10_DRIVER_TYPE_HARDWARE:
            return (WCHAR*)L"D3D10_DRIVER_TYPE_HARDWARE";
        case D3D10_DRIVER_TYPE_REFERENCE:
            return (WCHAR*)L"D3D10_DRIVER_TYPE_REFERENCE";
        case D3D10_DRIVER_TYPE_SOFTWARE:
            return (WCHAR*)L"D3D10_DRIVER_TYPE_WARP";
        case D3D10_DRIVER_TYPE_NULL:
            return (WCHAR*)L"D3D10_DRIVER_TYPE_NULL";
        default:
            return (WCHAR*)L"Unknown devType";
    }
}
